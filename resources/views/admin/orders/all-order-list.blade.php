...
<main>
    <div class="p-6 mx-auto max-w-7xl">
        <!-- Breadcrumb Start -->
        <div x-data="{ pageName: `All Orders List`}">
            <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">All Orders List</h2>
        ...
        <div class="border-t border-gray-100 py-6 dark:border-gray-800">
            <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900/50">
                <!-- Filter Form -->
                <div class="p-6">
                    <form action="{{ route('admin.all-orders') }}" method="GET" class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateExportButtonState() {
            ...
            if (exportSelectedButton) {
                exportSelectedButton.disabled = !hasSelectedOrders;
            }
        }
        ...
        if (exportSelectedButton) {
            exportSelectedButton.addEventListener('click', function() {
                ...
                showExportDialog(selectedOrders);
            });
        }
        ...
        function showExportDialog(selectedOrderIds = null) {
            Swal.fire({
                    ...
                    <div class="text-left space-y-4">
                        <div>
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="export_format" value="tsv" class="mr-2">
                        ...
                        <div class="p-3 bg-blue-50 border border-blue-200 rounded">
                            <p class="text-sm text-blue-800">
                                <strong>Sẽ export ${selectedOrderIds.length} đơn hàng đã chọn</strong>
                            </p>
                        </div>
                        ` : `
                        <div class="p-3 bg-green-50 border border-green-200 rounded">
                            <p class="text-sm text-green-800">
                                <strong>Sẽ export tất cả đơn hàng theo bộ lọc hiện tại</strong>
                            </p>
                        </div>
                        `}
                        <div class="p-2 bg-blue-50 border border-blue-200 rounded text-xs">
                            <div class="space-y-1">
                                <div>
                                    <strong class="text-blue-800">CSV:</strong>
                                    <span class="text-blue-700">External_ID format: '577020000000000000 (forced text)</span>
                                </div>
                                <div>
                                    <strong class="text-blue-800">TSV:</strong>
                                    <span class="text-blue-700">External_ID format: '577020000000000000 (forced text)</span>
                                </div>
                            </div>
                        </div>
                ...
                preConfirm: async () => {
                    ...
                    return await performExport(selectedOrderIds, format);
                }
            }).then((result) => {
        ...
        async function performExport(selectedOrderIds, format) {
            ...
            if (selectedOrderIds) {
                ...
                if (urlParams.get('external_id')) formData.append('external_id', urlParams.get('external_id'));
                if (urlParams.get('customer_name')) formData.append('customer_name', urlParams.get('customer_name'));
                if (urlParams.get('status')) formData.append('status', urlParams.get('status'));
                if (urlParams.get('warehouse')) formData.append('warehouse', urlParams.get('warehouse'));
                if (urlParams.get('created_at_min')) formData.append('date_from', urlParams.get('created_at_min'));
                if (urlParams.get('created_at_max')) formData.append('date_to', urlParams.get('created_at_max'));
            }
            ...
            try {
                ...
                Swal.showValidationMessage('Lỗi khi export: ' + error.message);
                return false;
            }
        }
    });
