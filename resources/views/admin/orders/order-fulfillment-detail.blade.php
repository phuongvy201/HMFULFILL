...
<style>
    ...
    .max-w-full::-webkit-scrollbar-thumb {
        background: #d1d5db;
        /* Màu của thanh cuộn - nhạt hơn */
        border-radius: 4px;
    }

    .max-w-full::-webkit-scrollbar-thumb:hover {
        background: rgb(219, 219, 219);
        /* Màu khi hover - đậm hơn một chút */
    }
</style>
<main>
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        ...
        <div class="border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6">
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="max-w-full overflow-x-auto rounded-xl shadow-sm">
...
<script>
    ...
    document.getElementById('uploadSelected').addEventListener('click', async function() {
        ...
        const selectedOrderIds = Array.from(selectedCheckboxes).map(checkbox => checkbox.closest('tr').dataset.orderId);
