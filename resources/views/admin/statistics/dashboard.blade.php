...
@section('title', 'Dashboard Thống Kê Đơn Hàng')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Dashboard Thống Kê Đơn Hàng</h1>
                    <p class="mt-2 text-sm text-gray-600">Tổng quan hoạt động kinh doanh</p>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Giá Trị TB/Đơn</dt>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Trạng Thái Đơn Hàng</h3>
                    </div>
                    <div class="p-6">
                        <div class="h-64 mb-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Thống Kê Theo Warehouse</h3>
                </div>
                <div class="p-6">
                    <div class="h-64 mb-4">
                    ...
                    <div class="space-y-2">
                        @foreach($warehouseStats as $warehouse => $count)
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Thống Kê Theo Khách Hàng</h3>
            </div>
            <div class="overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-1 bg-gray-200 rounded-full h-2 mr-3">
                                            <div class="bg-blue-600 h-2 rounded-full" style="width: {{ ($customer->order_count / $totalOrders) * 100 }}%"></div>
                                        </div>
                                        <span class="text-sm text-gray-600">{{ round(($customer->order_count / $totalOrders) * 100, 1) }}%</span>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    ...
    document.getElementById('periodFilter').addEventListener('change', function() {
        ...
        window.location.href = '{{ route("admin.statistics.dashboard") }}?period=' + period;
    });
</script>
@endsection