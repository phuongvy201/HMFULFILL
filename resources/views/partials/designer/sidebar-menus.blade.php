...
<!-- Menu Item Design Tasks -->
<li>
    <a href="{{ route('designer.tasks.index') }}"
        class="menu-item group"
        :class="(selectedMenu === 'DesignTasks') || (page === 'designTasks') ? 'menu-item-active' : 'menu-item-inactive'">
        <svg
            :class="(selectedMenu === 'DesignTasks') || (page === 'designTasks') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
